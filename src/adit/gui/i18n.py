...
_EN: dict[str, str] = {
    ...
    "入力を生成": "Generate input", "生成した入力をこの PC で実行": "Run the generated input on this PC", "操作": "Actions", "生成できます": "Ready to generate",
    "先に「入力を生成」を押してください": "Press “Generate input” first", "実行中": "Running",
    ...
    "入力の生成だけに使うなら外します (環境設定の enable_run に保存されます)": "Untick if you only generate input (saved as enable_run in the preferences)",
