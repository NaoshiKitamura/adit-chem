...
class MainWindow(QMainWindow):
    def __init__(self, cfg: Config, cfg_path: Path):
        ...
        self.btn_generate = QPushButton(icons.icon("generate", 16), "入力を生成"); self.btn_generate.setObjectName("primary"); self.btn_generate.setDefault(True)
    ...
    def _build_ribbon(self) -> None:
        ...
        self.act_generate = QAction(icons.icon("generate", 32), "入力を生成", self); self.act_generate.setShortcut("Ctrl+G"); self.act_generate.triggered.connect(self.generate)
