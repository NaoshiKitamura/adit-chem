...
使い方:  python analyze.py [--rdf] [--msd [元素]] [--dos] [--skip N] [--rmax R] [--sigma S]
...
ap.add_argument("--rdf", action="store_true", help="動径分布関数 (元素の全組み合わせ)")
...
a = ap.parse_args()
opts = AnalysisOptions(rdf=a.rdf, msd=a.msd is not None, msd_species=(a.msd or None), dos=a.dos, skip_frames=a.skip, rdf_rmax=a.rmax, dos_sigma=a.sigma)
